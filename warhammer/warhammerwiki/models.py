...
class Unit(models.Model):
    ...
    unit_desciption = models.TextField()
    ...
    melee_burnt = models.BooleanField(default=False)
    ...
    missile_poison_attack = models.BooleanField(default=False)
    ...
    missile_contaminated = models.BooleanField(default=False)
    missile_burnt = models.BooleanField(default=False)
    take_cover = models.BooleanField(default=False)
    poisoned_wind = models.BooleanField(default=False)
    madness_of_khaine = models.BooleanField(default=False)
    missile_discouraged = models.BooleanField(default=False)
