...
def populate():
    ...
    for race, race_data in races.items():
        ...
        for u in race_data['units']:
            add_unit(r, u['unit_name'], u['unit_image'], u['key'], u['weight'], u['cost'], u['upkeep'], u['mp_cost'], u['health'], u['health_per_entity'], u['armour'], u['bronze_shield'], u['silver_shield'], u['parry_chance'], u['ward_save'], u['physical_resistance'], u['missile_resistance'],
             ...
             u['weeping_blade'], u['disturbed'], u['charmed'], u['contaminated'], u['attack_interval'], u['melee_defence'], u['weapon_strenght'], u['melee_ap_yes_no'], u['melee_bonus_large_yes_no'], u['melee_bonus_inf_yes_no'], u['base_damage'],
                     ...
                     u['burnt'], u['take_cover'], u['poisoned_wind'], u['madness_of_khaine'], u['missile_discouraged'], u['missile_contaminated'], u['missile_base_damage'], u['missile_ap_damage'], u['missile_bonus_vs_infantry'],
...
def add_unit(race, unit_name, unit_image, key, weight, cost, upkeep, mp_cost, health, health_per_entity, armour, bronze_shield, silver_shield, parry_chance, ward_save, physical_resistance, missile_resistance, magic_resistance,
             ...
             missile_bonus_inf_yes_no, missile_poison_attack, missile_sundered_armour, zzzzap, flammable, blinded, monstrous_impact, missile_disturbed, shieldbreaker, burnt, take_cover, poisoned_wind, madness_of_khaine, missile_discouraged,
    ...
    u = Unit.objects.get_or_create(race=race, unit_name=unit_name, unit_image=unit_image, key=key, weight=weight, cost=cost, upkeep=upkeep, mp_cost=mp_cost, health=health, health_per_entity=health_per_entity, armour=armour, bronze_shield=bronze_shield,
   ...
   shieldbreaker=shieldbreaker, burnt=burnt, take_cover=take_cover, poisoned_wind=poisoned_wind, madness_of_khaine=madness_of_khaine, missile_discouraged=missile_discouraged, missile_contaminated=missile_contaminated, missile_base_damage=missile_base_damage, missile_ap_damage=missile_ap_damage, missile_bonus_vs_infantry=missile_bonus_vs_infantry, missile_bonus_vs_large=missile_bonus_vs_large,
